              ...
              <div id="trip-form" style={{ background: "#0d1524", padding: "20px", border: "1px solid #1a2a45", borderRadius: "12px", marginBottom: "12px" }}>
                <div style={{ display: "flex", flexDirection: "column", gap: "12px", marginBottom: "16px" }}>
                  ...
                  <div>
                    ...
                    <div style={{ display: "inline-flex", alignItems: "center", background: "#111e30", border: "1px solid #1a2a45", borderRadius: "6px", height: "44px", padding: "0 12px", minWidth: "100px" }}>
                      <NumericInput value={tripForm.fuelPrice} onChange={v => setTripForm(p => ({ ...p, fuelPrice: v }))} placeholder="44,50" style={{ background: "transparent", border: "none", color: "#e8eef8", padding: 0, width: "auto", minWidth: "40px", fontSize: "12px", fontFamily: FONT, outline: "none" }} />
                    ...
                    {(tripForm.tollItems||[]).length > 0 && (
                      <div style={{ marginBottom: "8px" }}>
                        <div style={{ marginBottom: "6px" }}>
                          ...
                          <div style={{ background: "#111e30", border: "1px solid #1a2a45", borderRadius: "6px", height: "44px", display: "flex", alignItems: "center", padding: "0 12px", fontSize: "12px", color: "#e8eef8", cursor: "default" }}>{formatNumber(tripTollTotal)} ₺</div>
                        </div>
                              ...
                              <div style={{ display: "flex", flexDirection: "column", gap: "10px", marginBottom: "12px" }}>
                                ...
                                <div>
                                  <div style={{ ...lbl, marginBottom: "4px" }}>Litre Fiyatı</div>
                                    <div style={{ display: "inline-flex", alignItems: "center", background: "#111e30", border: "1px solid #64d2ff", borderRadius: "6px", height: "44px", padding: "0 12px", minWidth: "100px" }}>
                                      <NumericInput value={editTripForm.fuelPrice} onChange={v => setEditTripForm(p => ({ ...p, fuelPrice: v }))} placeholder="44,50" style={{ background: "transparent", border: "none", color: "#e8eef8", padding: 0, width: "auto", minWidth: "40px", fontSize: "12px", fontFamily: FONT, outline: "none" }} />
                                      <span style={{ color: "#8aa4c8", fontSize: "12px", marginLeft: "4px", flexShrink: 0 }}>₺</span>
                                    </div>
                                </div>
                                <div>
                                  ...
                                  {(editTripForm.tollItems||[]).length > 0 && (
                                    <div style={{ marginTop: "4px" }}>
                                      <div style={{ marginBottom: "4px" }}>
                                        ...
                                        <div style={{ background: "#111e30", border: "1px solid #64d2ff", borderRadius: "6px", height: "44px", display: "flex", alignItems: "center", padding: "0 12px", fontSize: "12px", color: "#e8eef8", cursor: "default" }}>{formatNumber(editTripTollTotal)} ₺</div>
                                      </div>
